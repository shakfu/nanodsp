...
class fxdsp:
    ...
    class SidechainCompressor:
        ...
        def set_release(self, release: float) -> None: ...
        def process(
            self, buf: NDArray[np.float32], sidechain: NDArray[np.float32]
        ) -> NDArray[np.float32]: ...
    ...
    class TransientShaper:
        ...
        def init(self, sample_rate: float) -> None: ...
        def reset(self) -> None: ...
        def set_attack_gain(self, gain: float) -> None: ...
        def set_sustain_gain(self, gain: float) -> None: ...
        def set_fast_attack(self, time: float) -> None: ...
        def set_fast_release(self, time: float) -> None: ...
        def set_slow_attack(self, time: float) -> None: ...
        def set_slow_release(self, time: float) -> None: ...
        def process(self, input: NDArray[np.float32]) -> NDArray[np.float32]: ...
    ...
    class LookaheadLimiter:
        ...
        def set_lookahead_ms(self, ms: float) -> None: ...
        def set_release(self, release: float) -> None: ...
        def process(self, input: NDArray[np.float32]) -> NDArray[np.float32]: ...
...
class paulstretch:
    class PaulStretch:
        def __init__(self, window_size: int, sample_rate: float) -> None: ...
        @property
        def window_size(self) -> int: ...
        @property
